...
// @ts-ignore;
import { Calendar, MapPin, Users, Plus, Search, Filter, ChevronRight, Clock, CheckCircle, XCircle, Loader2, AlertCircle, RefreshCw } from 'lucide-react';
// @ts-ignore;
      ...
      <div className="bg-white rounded-b-3xl shadow-xl p-6 mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <Button className="bg-white text-[#FF8B4E] border-2 border-[#FF8B4E] h-12 px-4 rounded-xl shadow-lg hover:bg-[#FFF5F0]" onClick={handleRefresh} title="刷新">
              <RefreshCw className="h-5 w-5" />
            </Button>
            <Button className="bg-[#FF8B4E] text-white h-12 px-4 rounded-xl shadow-lg hover:bg-[#FF6B35] hover:shadow-xl transition-all" onClick={() => navigateTo({
